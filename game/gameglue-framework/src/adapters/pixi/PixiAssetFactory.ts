...
import type { PixiAudio } from "./PixiAudio";

export class PixiAssetFactory implements AssetFactorySubsystem {
  private readonly audio: PixiAudio;

  constructor(audio: PixiAudio) {
    this.audio = audio;
  }
