...
export class CanvasPhysics implements PhysicsSubsystem {
  ...
  updateBodyPosition(objectId: string, x: number, y: number): void {
  ...
  private detectCollisions(): Collision[] {
    ...
    for (let i = 0; i < entries.length; i++) {
      ...
      if (bodyA.type === "static") continue; // Only test dynamic bodies as "a"
