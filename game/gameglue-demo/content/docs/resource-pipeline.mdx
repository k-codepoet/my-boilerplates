---
title: 리소스 파이프라인
description: 프로그래매틱 vs 파일 기반 듀얼 모드 스프라이트 시스템
---
...
| 함수 | 크기 | 설명 |
|------|------|------|
| `drawPlayerIdle()` | 28x36 | 파란 몸통 + 눈, 발 아래 대칭 |
| `drawPlayerWalk1()` | 28x36 | 왼발 위/오른발 아래 (걷기 프레임 1) |
| `drawPlayerWalk2()` | 28x36 | 오른발 위/왼발 아래 (걷기 프레임 2) |
| `drawPlayerJump()` | 28x36 | 발을 모아 올린 점프 자세 |
| `drawPlatform()` | 120x19 | 위 3px 잔디(#22c55e) + 아래 16px 돌(#78716c) |
| `drawGround()` | 800x50 | 어두운 돌(#57534e) + 상단 하이라이트 |
| `drawCoin()` | 14x14 | 노란 원(#eab308) + 흰 광택 |
| `drawEnemy()` | 26x26 | 빨간 몸통(#ef4444) + 분노 눈썹 |
...
| 파일 경로 | 크기 |
|-----------|------|
| `/assets/platformer/player-idle.png` | 28x36 |
| `/assets/platformer/player-walk-1.png` | 28x36 |
| `/assets/platformer/player-walk-2.png` | 28x36 |
| `/assets/platformer/player-jump.png` | 28x36 |
| `/assets/platformer/platform.png` | 120x19 |
| `/assets/platformer/ground.png` | 800x50 |
| `/assets/platformer/coin.png` | 14x14 |
| `/assets/platformer/enemy.png` | 26x26 |
