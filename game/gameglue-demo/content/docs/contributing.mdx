---
title: 개발 가이드
description: 프로젝트 구조, 새 게임 템플릿/Trait/어댑터 추가 방법
---
...
어댑터는 엔진과 렌더링/물리 백엔드를 연결하는 추상화 레이어다. 현재 4개 어댑터가 구현되어 있다: Canvas 2D, PixiJS v8, Three.js, Phaser 3. 상세 내용은 [어댑터 패턴](/docs/adapter-pattern) 참조.
