---
title: AI 게임 생성 프로토콜
description: AI가 GameGlue로 게임을 만드는 6단계 프로토콜
---
...
```
하나의 Game.ts에 Scene, GameObject, 로직 전부 작성 — 잘못된 방법
...
```
engine/Scene.ts에 커스텀 로직 추가 — 금지
traits/Movable.ts 수정하여 게임 특화 로직 삽입 — 금지
adapters/ 코드 변경 — 금지
