---
title: 비전과 설계 철학
description: GameGlue Framework의 설계 철학과 아키텍처 계층 구조
---
...
- 엔진 코어 모듈 → [엔진 코어 모듈](/docs/engine-modules)
- Trait 시스템 → [Trait 시스템](/docs/trait-system)
- 어댑터 패턴 → [어댑터 패턴](/docs/adapter-pattern)
- 메모리 최적화 → [메모리 최적화](/docs/memory-optimization)
- React 통합 → [React 통합](/docs/react-integration)
