...
SSR 풀스택 boilerplate. Cloudflare Workers에서 서버 사이드 렌더링을 지원합니다.
...
```bash
# 1. 복제
cp -r boilerplates/web/react-router-cloudflare apps/{프로젝트명}
cd apps/{프로젝트명}

# 2. package.json name 수정
# "@boilerplates/react-router-cloudflare" → "@apps/{프로젝트명}"
